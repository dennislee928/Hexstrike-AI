...
export default function OneGadgetPage() {
  ...
  const handleScan = async () => {
    setIsRunning(true)
    try {
      const response = await fetch('https://hexstrike-ai.dennisleehappy.org/api/tools/one-gadget', {
        method: 'POST',
