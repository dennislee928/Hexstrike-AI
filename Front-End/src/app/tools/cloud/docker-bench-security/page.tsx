...
export default function DockerBenchSecurityPage() {
  ...
  const handleScan = async () => {
    setIsRunning(true)
    try {
      const response = await fetch('https://hexstrike-ai.dennisleehappy.org/api/tools/docker-bench-security', {
        method: 'POST',
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 space-y-6">
          <ToolForm 
            title="Configuration"
            subtitle="Configure DockerBenchSecurity"
