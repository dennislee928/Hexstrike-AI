...
export default function WaybackurlsPage() {
  ...
  const scanProfiles = [
    { id: 'standard', name: 'Standard Search', description: 'Find historical URLs', estimatedTime: '3-5 minutes', config: {} }
  ]
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-cyber font-bold text-neon-blue neon-glow">WAYBACKURLS</h1>
          <p className="text-cyber-light font-mono text-sm mt-1">URL discovery</p>
        </div>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 space-y-6">
          <ToolForm title="Configuration" subtitle="Configure Waybackurls" icon={<Clock className="h-5 w-5 text-neon-blue" />} isRunning={isRunning} onSubmit={handleScan}>
